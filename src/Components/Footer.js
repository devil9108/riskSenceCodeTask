...
export default function FooterComponent() {
    return (
        <Row>
            <Col span={6}>
                <Title level={3} style={{color:'white'}}>HUBSTAFF TALENT</Title>
            </Col>
            <Col span={4}>
                <Text strong style={{color:'white'}}>TALENT</Text>
                <br />
                <br />
            ...
            <Col span={4}>
                <Text strong style={{color:'white'}}>HUBSTAFF</Text>
                <br />
                <br />
            ...
            <Col span={6}>
            <Text strong style={{color:'white'}}>SOCIAL</Text>
                <br />
                <br />
                <TwitterOutlined  style={{color:'#93a4bc', fontSize:'20px', marginRight:'10px'}}/>
                <FacebookOutlined style={{color:'#93a4bc', fontSize:'20px', marginRight:'10px'}}/>
